...
public abstract class Handle {
     ...
     */
    public abstract CheckResult Check(PermissionManage obj, String permission);

    /**
     * 进行权限申请，如果被永久拒绝的权限，应该走提示设置，然后转到设置
     */
    public abstract void Request(PermissionManage obj, String permission, RequestCallback callback);
